...
INSERT OR IGNORE INTO tee_groups (id, round_id, group_number, scheduled_time, scorer_player_id) VALUES
  ...
  ('tg-1-5', 'round-1', 5, '10:53:00', 'p-luke');

INSERT OR IGNORE INTO tee_group_matches (tee_group_id, match_id) VALUES
...
INSERT OR IGNORE INTO tee_group_entries (tee_group_id, scramble_entry_id) VALUES
  ('tg-2-1', 's2-t1-ad'), ('tg-2-1', 's2-t2-bc'),
  ('tg-2-2', 's2-t2-ad'), ('tg-2-2', 's2-t4-bc'),
  ('tg-2-3', 's2-t3-ad'), ('tg-2-3', 's2-t5-bc'),
